              ...
              {stats && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-6 text-white">
                    ...
                    <p className="text-4xl font-bold mt-2 text-white">{stats.total_rows.toLocaleString()}</p>
                  </div>

                  {/* Total Products */}
                  <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-6 text-white">
                    <h4 className="text-sm font-medium uppercase tracking-wide">Total Products</h4>
                    <p className="text-4xl font-bold mt-2 text-white">{stats.total_products.toLocaleString()}</p>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                    ...
                    <p className="text-lg font-semibold mt-2 text-gray-900">
                      {(stats.sales_summary?.avg_daily_units ?? 0).toFixed(2)}
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                    ...
                    <p className="text-lg font-semibold mt-2 text-gray-900">
                      {(stats.sales_summary?.max_daily_units ?? 0).toLocaleString()}
                    </p>
                  </div>
                </div>
              )}
